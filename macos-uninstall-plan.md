...
```bash
brew uninstall --cask alt-tab background-music caffeine cleanshot discord monitorcontrol raycast shottr slack spotify whatsapp-for-mac karabiner-elements orbstack
brew cleanup
```
